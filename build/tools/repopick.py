...
if __name__ == '__main__':
    # Default to WaveOS Gerrit
    default_gerrit = 'http://gerrit.waveos.tk'
    ...
    for item in mergables:
        ...
        if args.gerrit == default_gerrit:
            ...
            if args.pull:
                cmd = ['git pull --no-edit wave', item['fetch'][method]['ref']]
            else:
                cmd = ['git fetch wave', item['fetch'][method]['ref']]
            if args.quiet:
                cmd.append('--quiet')
            else:
                print(cmd)
