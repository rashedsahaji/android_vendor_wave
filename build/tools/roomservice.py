...
custom_default_revision = "π"
custom_dependencies = "wave.dependencies"
org_manifest = "WaveOS"  # leave empty if org is provided in manifest
org_display = "WaveOS"  # needed for displaying
...
def add_to_manifest(repos, fallback_branch=None):
	...
	existing_m_project = None
        ...
        elif exists_in_tree(wavem, repo_target) != None:
	    existing_m_project = exists_in_tree(wavem, repo_target)
