...
PRODUCT_COPY_FILES += \
    ...
    vendor/wave/CHANGELOG.mkdn:system/etc/CHANGELOG-CM.txt
...
PRODUCT_COPY_FILES += \
    ...
    vendor/wave/prebuilt/common/bin/50-cm.sh:system/addon.d/50-cm.sh \
    vendor/wave/prebuilt/common/bin/blacklist:system/addon.d/blacklist

# Backup Services whitelist
PRODUCT_COPY_FILES += \
    vendor/wave/config/permissions/backup.xml:system/etc/sysconfig/backup.xml

# Signature compatibility validation
PRODUCT_COPY_FILES += \
    vendor/wave/prebuilt/common/bin/otasigcheck.sh:install/bin/otasigcheck.sh
...
# userinit support
PRODUCT_COPY_FILES += \
    vendor/wave/prebuilt/common/etc/init.d/90userinit:system/etc/init.d/90userinit
endif

# CM-specific init file
PRODUCT_COPY_FILES += \
    vendor/wave/prebuilt/common/etc/init.local.rc:root/init.cm.rc

# Copy over added mimetype supported in libcore.net.MimeUtils
PRODUCT_COPY_FILES += \
    vendor/wave/prebuilt/common/lib/content-types.properties:system/lib/content-types.properties
...
# This is CM!
PRODUCT_COPY_FILES += \
    vendor/wave/config/permissions/com.cyanogenmod.android.xml:system/etc/permissions/com.cyanogenmod.android.xml

# Include CM audio files
include vendor/wave/config/cm_audio.mk

# Theme engine
include vendor/wave/config/themes_common.mk

ifneq ($(TARGET_DISABLE_CMSDK), true)
# CMSDK
include vendor/wave/config/cmsdk_common.mk
endif
...
ifeq ($(OTA_PACKAGE_SIGNING_KEY),)
    PRODUCT_EXTRA_RECOVERY_KEYS += \
        vendor/wave/build/target/product/security/cm \
        vendor/wave/build/target/product/security/cm-devkey
endif

-include vendor/wave-priv/keys/keys.mk
...
-include vendor/wave/config/partner_gms.mk
